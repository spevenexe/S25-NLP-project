...
interface QuestionGeneratorProps {
    fileName: string
    onQuestionsGenerated: (questions: Array<{ id: number; text: string }>) => void
    setIsLoading: (loading: boolean) => void
}

export function QuestionGenerator({ fileName, onQuestionsGenerated, setIsLoading }: QuestionGeneratorProps) {
